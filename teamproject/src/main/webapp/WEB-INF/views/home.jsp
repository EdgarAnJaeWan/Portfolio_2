					...
					<div class="col-lg-8 p-r-0 title-margin-right">
						<div class="page-header">
							<div class="page-title">
								<h1>Welcome to our Population Homepage !!!</h1>
							</div>
						</div>
					</div>
				...
				<section id="main-content">
						...
						<div class="row">
								...
								<div class="card">
									<div class="stat-widget-two card-body">
										<div class="stat-content">
											...
											<div class="stat-digit">Region</div>
											<div class="stat-text">각 지역의 인구수를</div>
											<div class="stat-text">간편하게 조회하실 수 있습니다.</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-3 col-sm-6">
								<div class="card">
									<div class="stat-widget-two card-body">
										<div class="stat-content">
											<div class="stat-digit">Household</div>
											<div class="stat-text">각 지역의 세대수를</div>
											<div class="stat-text">간편하게 조회하실 수 있습니다.</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-3 col-sm-6">
								<div class="card">
									<div class="stat-widget-two card-body">
										<div class="stat-content">
											<div class="stat-digit">Gender</div>
											<div class="stat-text">각 지역의 남여별 인구수를</div>
											<div class="stat-text">간편하게 조회하실 수 있습니다.</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-3 col-sm-6">
								<div class="card">
									<div class="stat-widget-two card-body">
										<div class="stat-content">
											<div class="stat-digit">Board</div>
											<div class="stat-text">게시판은 다른 회원분들과</div>
											<div class="stat-text">소통할 수 있는 공간입니다.</div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="row">
							<div class="col-lg-4">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">- 데이터를 보는 2가지 방법</h4>
									</div>
								</div>
							</div>
					</div>				
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="card">
								<div class="card-body text-center">
									<div class="m-t-10">
										<h2 class="mt-3">통계표</h2>
										<h4 class="card-title">(특정지역 세대수 조회시 다음 화면이 출력)</h4>										
									</div>
									<table class="table">
						...
						<div class="col-lg-6">
							<div class="card">
								<div class="card-body text-center">
									<div class="m-t-10">
										<h2 class="mt-3">그래프</h2>
										<h4 class="card-title">(특정지역 남녀 인구수 조회시 다음 화면이 출력)</h4>										
									</div>
									<div class="card-body">
										<div class="row">
											<div class="col-xl-12 col-lg-8">
												<div id="morris-bar-chart"
													...
													<svg height="342" version="1.1" width="734.656"
														...
														<text x="33.421875" y="301" text-anchor="end"
														...
														<path fill="none" stroke="#eef0f2"
															d="M45.921875,301H709.656" stroke-width="0.5"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
														<text x="33.421875" y="232" text-anchor="end"
															font-family="sans-serif" font-size="12px" stroke="none"
															fill="#888888"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: end; font-family: sans-serif; font-size: 12px; font-weight: normal;"
															font-weight="normal">
														...
														<path fill="none" stroke="#eef0f2"
															d="M45.921875,232H709.656" stroke-width="0.5"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
														<text x="33.421875" y="163" text-anchor="end"
															font-family="sans-serif" font-size="12px" stroke="none"
															fill="#888888"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: end; font-family: sans-serif; font-size: 12px; font-weight: normal;"
															font-weight="normal">
														...
														<path fill="none" stroke="#eef0f2"
															d="M45.921875,163H709.656" stroke-width="0.5"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
														<text x="33.421875" y="94.00000000000003"
														...
														<path fill="none" stroke="#eef0f2"
															d="M45.921875,94.00000000000003H709.656"
															stroke-width="0.5"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
														...
														<path fill="none" stroke="#eef0f2"
															d="M45.921875,25H709.656" stroke-width="0.5"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
														<text x="662.2464196428571" y="313.5" text-anchor="middle"
															font-family="sans-serif" font-size="12px" stroke="none"
															fill="#888888"
														...
														<text x="567.4272589285714" y="313.5" text-anchor="middle"
															font-family="sans-serif" font-size="12px" stroke="none"
															fill="#888888"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
															font-weight="normal" transform="matrix(1,0,0,1,0,8)">
														...
														<text x="472.6080982142857" y="313.5" text-anchor="middle"
															font-family="sans-serif" font-size="12px" stroke="none"
															fill="#888888"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
															font-weight="normal" transform="matrix(1,0,0,1,0,8)">
														...
														<text x="377.7889375" y="313.5" text-anchor="middle"
															font-family="sans-serif" font-size="12px" stroke="none"
															fill="#888888"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
															font-weight="normal" transform="matrix(1,0,0,1,0,8)">
														...
														<text x="282.96977678571426" y="313.5"
														...
														<text x="188.15061607142857" y="313.5"
															text-anchor="middle" font-family="sans-serif"
															font-size="12px" stroke="none" fill="#888888"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
															font-weight="normal" transform="matrix(1,0,0,1,0,8)">
														...
														<text x="93.33145535714286" y="313.5" text-anchor="middle"
															font-family="sans-serif" font-size="12px" stroke="none"
															fill="#888888"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
															font-weight="normal" transform="matrix(1,0,0,1,0,8)">
														...
														<rect x="57.774270089285714" y="25"
															width="34.057185267857136" height="276" rx="0" ry="0"
															fill="#343957" stroke="none" fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="94.83145535714286" y="52.60000000000002"
															width="34.057185267857136" height="248.39999999999998"
															rx="0" ry="0" fill="#5873fe" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="152.59343080357144" y="94.00000000000003"
															width="34.057185267857136" height="206.99999999999997"
															rx="0" ry="0" fill="#343957" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="189.65061607142857" y="121.60000000000002"
															width="34.057185267857136" height="179.39999999999998"
															rx="0" ry="0" fill="#5873fe" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="247.41259151785712" y="163"
															width="34.057185267857136" height="138" rx="0" ry="0"
															fill="#343957" stroke="none" fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="284.46977678571426" y="190.60000000000002"
															width="34.057185267857136" height="110.39999999999998"
															rx="0" ry="0" fill="#5873fe" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="342.2317522321428" y="94.00000000000003"
															width="34.057185267857136" height="206.99999999999997"
															rx="0" ry="0" fill="#343957" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="379.2889375" y="121.60000000000002"
															width="34.057185267857136" height="179.39999999999998"
															rx="0" ry="0" fill="#5873fe" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="437.0509129464285" y="163"
															width="34.057185267857136" height="138" rx="0" ry="0"
															fill="#343957" stroke="none" fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="474.10809821428563" y="190.60000000000002"
															width="34.057185267857136" height="110.39999999999998"
															rx="0" ry="0" fill="#5873fe" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="531.8700736607142" y="94.00000000000003"
															width="34.057185267857136" height="206.99999999999997"
															rx="0" ry="0" fill="#343957" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="568.9272589285713" y="121.60000000000002"
															width="34.057185267857136" height="179.39999999999998"
															rx="0" ry="0" fill="#5873fe" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="626.6892343749998" y="25"
															width="34.057185267857136" height="276" rx="0" ry="0"
															fill="#343957" stroke="none" fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect>
														<rect x="663.746419642857" y="52.60000000000002"
															width="34.057185267857136" height="248.39999999999998"
															rx="0" ry="0" fill="#5873fe" stroke="none"
															fill-opacity="1"
															style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 1;"></rect></svg>
													<div class="morris-hover morris-default-style"
														style="left: 617.457px; top: 129px; display: none;">
														<div class="morris-hover-row-label">2012</div>
														<div class="morris-hover-point" style="color: #343957">
															A: 100</div>
														<div class="morris-hover-point" style="color: #5873FE">
															B: 90</div>
													</div>
												</div>
											</div>
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">- 출처 및 인구 통계 관련 사이트 소개 </h4>
									</div>
									<div class="card-body">
										<div class="current-progress">
											<div class="progress-content py-2">
												<div class="row">
													<div class="col-lg-4">
														<div class="progress-text">행정안전부 | 
														<a href="https://www.mois.go.kr/frt/a01/frtMain.do">https://www.mois.go.kr/frt/a01/frtMain.do
														</a></div>
													</div>
													<div class="col-lg-8">
														<div class="current-progressbar">
															<div class="progress">
																<div class="progress-bar progress-bar-primary w-80"
											...
											<div class="progress-content py-2">
												<div class="row">
													<div class="col-lg-4">
														<div class="progress-text">국가통계포털 | 
														<a href="https://kosis.kr/index/index.do">https://kosis.kr/index/index.do
														</a></div>
													</div>
													<div class="col-lg-8">
														<div class="current-progressbar">
											...
											<div class="progress-content py-2">
												<div class="row">
													<div class="col-lg-4">
														<div class="progress-text">공공데이터포털 | 
														<a href="https://www.data.go.kr/index.do">https://www.data.go.kr/index.do
														</a></div>
													</div>
													<div class="col-lg-8">
														<div class="current-progressbar">
															<div class="progress">
																<div class="progress-bar progress-bar-primary w-5"
											...
											<div class="progress-content py-2">
												<div class="row">
													<div class="col-lg-4">
														<div class="progress-text">서울 열린데이터 광장 | 
														<a href="https://data.seoul.go.kr/index.do">https://data.seoul.go.kr/index.do
														</a></div>
													</div>
													<div class="col-lg-8">
														<div class="current-progressbar">
											...
											<div class="progress-content py-2">
												<div class="row">
													<div class="col-lg-4">
														<div class="progress-text">부산 공공데이터포털 | 
														<a href="https://data.busan.go.kr/index.nm">https://data.busan.go.kr/index.nm
														</a></div>
													</div>
													<div class="col-lg-8">
														<div class="current-progressbar">
															<div class="progress">
																<div class="progress-bar progress-bar-primary w-0"
								...
								<div class="card">
									<div class="card-body">
										<div class="testimonial-widget-one p-17">
											<div
												class="testimonial-widget-one owl-carousel owl-theme owl-loaded owl-drag"
												style="">
												...
												<div class="owl-stage-outer">
													<div class="owl-stage"
														style="transform: translate3d(-684px, 0px, 0px); transition: all 0s ease 0s; width: 2397px;">
														<div class="owl-item cloned"
															style="width: 332.328px; margin-right: 10px;">
															<div class="item">
																<div class="testimonial-content">
																	...
																	<div class="media">
																		<div class="media-body">
																			<div class="testimonial-author">TYRION
																				LANNISTER</div>
									...
									<div class="card-body">
										<div class="cpu-load-chart">
											<div id="cpu-load" class="cpu-load"
												...
												<canvas class="flot-base" width="332" height="150"
													style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 332.328px; height: 150px;"></canvas>
												<div class="flot-text"
													style="position: absolute; inset: 0px; font-size: smaller; color: rgb(84, 84, 84);">
													<div class="flot-y-axis flot-y1-axis yAxis y1Axis"
														style="position: absolute; inset: 0px;">
														<div class="flot-tick-label tickLabel"
															style="position: absolute; top: 134px; left: 13px; text-align: right;">0</div>
														<div class="flot-tick-label tickLabel"
															style="position: absolute; top: 101px; left: 7px; text-align: right;">25</div>
														<div class="flot-tick-label tickLabel"
														...
														<div class="flot-tick-label tickLabel"
															style="position: absolute; top: 0px; left: 0px; text-align: right;">100</div>
													</div>
												</div>
												<canvas class="flot-overlay" width="332" height="150"
													style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 332.328px; height: 150px;"></canvas>
											</div>
										</div>
									</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div id="vmap13" class="vmap"
											...
											<svg width="533.5" height="400">
												<g
													transform="scale(0.5563086548488009) translate(0, 63.01265229615742)">
												<path
													...
													stroke="rgb(88, 115, 254)" stroke-width="1"
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_hi"
												...
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ak"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_fl"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_nh"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_mi"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_vt"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_me"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ri"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ny"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_pa"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_nj"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_de"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_md"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_va"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_wv"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_oh"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_in"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_il"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ct"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_wi"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_nc"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_dc"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ma"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_tn"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ar"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_mo"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ga"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_sc"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ky"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_al"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_la"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ms"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ia"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_mn"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ok"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_tx"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_nm"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ks"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ne"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_sd"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_nd"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_wy"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_mt"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_co"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_id"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ut"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_az"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_nv"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_or"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_wa"
													class="jqvmap-region"></path>
												<path
													...
													stroke-linecap="round" stroke-linejoin="round"
													stroke-opacity="0.25" fill="rgb(88, 115, 254)"
													original="rgb(88, 115, 254)" id="jqvmap1_ca"
										...
										<div class="widget-timeline ps ps--active-y">
											<ul class="timeline">
												<li>
													...
													class="timeline-panel text-muted" href="#"> <span>10
															minutes ago</span>
														<h6 class="m-t-5">Youtube, a video-sharing website,
															goes live.</h6>
												</a>
												</li>
												...
												<li>
													...
													class="timeline-panel text-muted" href="#"> <span>20
															minutes ago</span>
														<h6 class="m-t-5">Mashable, a news website and blog,
															goes live.</h6>
												</a>
												</li>
												...
												<li>
													...
													class="timeline-panel text-muted" href="#"> <span>30
															minutes ago</span>
												...
												<li>
													...
													class="timeline-panel text-muted" href="#"> <span>15
															minutes ago</span>
											...
											<div class="ps__rail-y"
												...
												<div class="ps__thumb-y" tabindex="0"
													style="top: 0px; height: 199px;"></div>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="todo-list">
											<div class="tdl-holder">
												<div class="tdl-content widget-todo mr-4 ps ps--active-y">
													...
													<div class="ps__rail-y"
														style="top: 98px; height: 210px; right: 0px;">
														<div class="ps__thumb-y" tabindex="0"
															style="top: 67px; height: 143px;"></div>
													</div>
												</div>
												<div class="px-4">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="chart py-4">
											...
											<canvas id="sold-product"
												style="display: block; width: 332px; height: 230px;"
												width="332" height="230" class="chartjs-render-monitor"></canvas>
										</div>
									</div>
								</div>
							</div>
